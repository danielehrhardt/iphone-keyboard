...
public struct LanguageRules: Sendable {
    ...
    /// the sentence: "z.B. morgen", "Mr. Smith".
    ...
    public static let german = LanguageRules(
        abbreviations: ["z.b", "bzw", "usw", "etc", "ca", "dr", "prof", "nr", "str", "evtl", "ggf", "inkl", "vgl", "zzgl",
                        "mfg", "vlt", "vllt", "bsp", "d.h", "u.a", "o.ä", "s.o", "s.u"],
    ...
    public static let english = LanguageRules(
        abbreviations: ["mr", "mrs", "ms", "dr", "prof", "sr", "jr", "st", "vs", "etc", "e.g", "i.e", "approx", "inc",
                        "ltd", "co", "dept", "est", "fig", "vol", "a.m", "p.m", "u.s", "u.k", "misc", "govt", "asap"],
